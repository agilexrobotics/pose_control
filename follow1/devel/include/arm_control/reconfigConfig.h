...
// *********************************************************
//
// File autogenerated for the arm_control package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __arm_control__RECONFIGCONFIG_H__
#define __arm_control__RECONFIGCONFIG_H__
...
namespace arm_control
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(reconfigConfig &config, const reconfigConfig &max, const reconfigConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const reconfigConfig &config1, const reconfigConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, reconfigConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const reconfigConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, reconfigConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const reconfigConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const reconfigConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, reconfigConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.Kp = 7.1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(reconfigConfig::AbstractParamDescriptionConstPtr(new reconfigConfig::ParamDescription<double>("Kp", "double", 0, "Kp", "", &reconfigConfig::Kp)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(reconfigConfig::AbstractParamDescriptionConstPtr(new reconfigConfig::ParamDescription<double>("Kp", "double", 0, "Kp", "", &reconfigConfig::Kp)));
