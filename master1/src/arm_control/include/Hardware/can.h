...
public:
    ...
    void Send_moto_123(uint16_t motor_id, float kp, float kd, float pos, float spd, float tor);
    void Send_moto_456(uint16_t motor_id, float kp, float kd, float pos, float spd, float tor);
